...
class Step(object):
    ...
    def __init__(self, template, name=None, group_name=None, letter_num=1):
        self.name = name
...
class DynamicStep(Step):
    ...
    def __init__(self, name, group_name, letter_num=1):
        super().__init__('dynamic', name, group_name, letter_num)
        self.controls = []
